...
class Config:
    ...
    def _load_config(self) -> Dict[str, Any]:
        ...
        result: Dict[str, Any] = {
            ...
            # Bing Grounding with Custom Search
            "bing_grounding_resource_key": os.getenv("BING_GROUNDING_RESOURCE_KEY", ""),
            "bing_grounding_resource_name": os.getenv("BING_GROUNDING_RESOURCE_NAME", ""),
            "bing_grounding_config_id": os.getenv("BING_GROUNDING_CONFIG_ID", ""),
        }
        return result
